 ...
 */
    ...
    (() => {
        ...
        moon.onclick = () => {
            ...
            if (moon.classList.contains("fa-sun")) document.body.classList.add("active"); else document.body.classList.remove("active");
        };
        window.onscroll = () => {
            let maxHeight = window.document.body.scrollHeight - window.innerHeight;
            let percetage = window.scrollY / maxHeight * 100;
            document.querySelector(".header__menu .scroll-indication").style.width = percetage + "%";
        };
